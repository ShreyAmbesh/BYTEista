...
import byteista.sahayam.ActivityInterests;
import byteista.sahayam.ActivityLibrary;
import byteista.sahayam.ActivityMess;
import byteista.sahayam.MainActivity.ActivityEvents;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       drawerRecycler.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), drawerRecycler, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                if (position==1)
                    startActivity(new Intent(getActivity(),ActivityEvents.class));
                else if (position==2)
                    startActivity(new Intent(getActivity(), ActivityLibrary.class));
                else if (position==3)
                    startActivity(new Intent(getActivity(), ActivityMess.class));
                else if(position==4)
                    startActivity(new Intent(getActivity(),ActivityInterests.class));
